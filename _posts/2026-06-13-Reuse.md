...
The concept of reuse of code and data is a central principle of programming.  
...
In CAD, every time you want to specify the Origin for the insertion point of a Block, or the start point of a line, centre of a circle etc. you have to type in `0,0,0`.  
...
Then later on you want to be able to change the base value to `8.5` and the X-Coordinate factor to be `x3` instead of `x4`?
...
This enables deep, complex relationships of Values and Objects to be created, enabling examples, like the one in the Background section above, to be specified and then visualised in **LIVE** for further editing and updating of the Model.
...
You also have the ability to Select from existing Objects of the suitable Type, in a List dialog box. (yes, even a **List** is a Type)
