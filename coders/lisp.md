...
- Lisp
  ...
  - [Lisp Basics](#lisp-basics)
    ...
    - [Object Oriented Lisp](#object-oriented-lisp)
  - [Documents](#documents)
...
While it is primarily considered to be a functional language, Lisp has been extended to be whatever is required, including an Object Oriented (OO) language.
