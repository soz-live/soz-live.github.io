...
# Class:	DCLS-Cluster-BoxedColumn
...
| Abstract?: | No |
| isValue?: | Yes |
| Help: | DCL Column Structure |

### DCLS-Cluster-BoxedColumn-Make
...
| --- | --- | --- |
| Returns: | [DCLS-Cluster-BoxedColumn](DCLS-Cluster-BoxedColumn.html) |
| Help: | Basic DCLS-Cluster-BoxedColumn |
