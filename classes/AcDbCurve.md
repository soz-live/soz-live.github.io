...
### AcDbCurve-User_Command

| Keys | Types | Help |
| --------- | --------- | --------- |
| USER | [User](User.html) |  |
| | | |
| Returns: | [AcDbCurve](AcDbCurve.html) | |
| Help: | | Make a AcDbCurve |
