...
# Class:	SZCELine-2xPoints

| Fields | Values |
| --------- | --------- |
| Superclass: | [SZCELine](SZCELine.html) |
| Subclasses: |  |
| Interfaces: |  |
| Interfaced: |  |
| Abstract?: | No |
| isValue?: | No |
| Help: | A Line using 2x Points |

### SZCELine-2xPoints-Make

| Keys | Types |
| --------- | --------- |
| SPACE | [AcDbBlock](AcDbBlock.html) |
| STARTPT | [SZGEPoint](SZGEPoint.html) |
| ENDPT | [SZGEPoint](SZGEPoint.html) |
| **---** | **---** |
