...
| Types | Functions |
| --------- | --------- |
| Class: | [AcDbCircle-Area](#AcDbCircle-Area) <br> [AcDbCircle-Center](#AcDbCircle-Center) <br> [AcDbCircle-Circumference](#AcDbCircle-Circumference) <br> [AcDbCircle-Diameter](#AcDbCircle-Diameter) <br> [AcDbCircle-Normal](#AcDbCircle-Normal) <br> [AcDbCircle-Radius](#AcDbCircle-Radius) <br> [AcDbCircle-User_Prompt](#AcDbCircle-User_Prompt) |
