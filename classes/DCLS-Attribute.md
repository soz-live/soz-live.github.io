...
| Subclasses: | [DCLS-Attribute-Option](DCLS-Attribute-Option.html) <br> [DCLS-Attribute-Integer](DCLS-Attribute-Integer.html) <br> [DCLS-Attribute-String](DCLS-Attribute-String.html) |
| Interfaces: |  |
| Interfaced: |  |
| Abstract?: | Yes |
| isValue?: | Yes |
