...
# Class:	DCLS-Cluster-ClassTreeFilter
...
| Superclass: | [DCLS-Cluster-Row](DCLS-Cluster-Row.html) |
| Subclasses: |  |
| Interfaces: |  |
| Interfaced: |  |
| Abstract?: | No |
...
### DCLS-Cluster-ClassTreeFilter-Make
...
| | | |
| Returns: | [DCLS-Cluster-ClassTreeFilter](DCLS-Cluster-ClassTreeFilter.html) | |
| Help: | | Basic DCLS-Cluster-ClassTreeFilter |
