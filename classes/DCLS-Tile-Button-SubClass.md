...
| --------- | --------- |
| Repo: | soz-live |
| Superclass: | [DCLS-Tile-Button](DCLS-Tile-Button.html) |
| Subclasses: | [DCLS-Tile-Button-KeySubClass](DCLS-Tile-Button-KeySubClass.html) |
| Interfaces: |  |
| Interfaced: |  |
| Abstract?: | No |
| isValue?: | Yes |
| Help: | DCL SubClass Button |

### DCLS-Tile-Button-SubClass-Make

| Keys | Types |
| --------- | --------- |
| USER | [User](User.html) |
| **---** | **---** |
| Returns: | [DCLS-Tile-Button-SubClass](DCLS-Tile-Button-SubClass.html) |
| Help: | SubClass Button Constructor |
