...
# Class:	DCLS-Dialog-List-DocPreview
...
| Abstract?: | No |
| isValue?: | Yes |
| Help: | SOZDCLDialog Strings |

### DCLS-Dialog-List-DocPreview-Make
...
| **---** | **---** |
| Returns: | [DCLS-Dialog-List-DocPreview](DCLS-Dialog-List-DocPreview.html) |
| Help: | DCLS-Dialog-List-DocPreview |
