...
# Class:	Filter-Point-AND

| Fields | Values |
| --------- | --------- |
| Superclass: | [Filter](Filter.html) |
| Subclasses: |  |
| Interfaces: |  |
| Interfaced: |  |
| Abstract?: | No |
| isValue?: | Yes |
| Help: | Filter Point-AND Structure |

### Filter-Point-AND-Make

| Keys | Types |
| --------- | --------- |
| X | [Filter](Filter.html) |
| Y | [Filter](Filter.html) |
| Z | [Filter](Filter.html) |
| **---** | **---** |
| Returns: | [Filter-Point-AND](Filter-Point-AND.html) |
| Help: | Basic Filter Point-AND Constructor |
