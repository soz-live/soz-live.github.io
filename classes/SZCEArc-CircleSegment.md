...
| Fields | Values |
| --------- | --------- |
| Superclass: | [SZCEArc](SZCEArc.html) |
| Subclasses: |  |
| Interfaces: |  |
| Interfaced: |  |
| Abstract?: | No |
| isValue?: | No |
| Help: | SZCEArc-CircleSegment Class |
