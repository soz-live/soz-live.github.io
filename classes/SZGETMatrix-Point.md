...
| Abstract?: | No |
| isValue?: | Yes |
| Help: | SZGETMatrix-Point Class |

### SZGETMatrix-Point-Make

| Keys | Types |
| --------- | --------- |
| POINT | [SZGEPoint](SZGEPoint.html) |
| **---** | **---** |
| Returns: | [SZGETMatrix-Point](SZGETMatrix-Point.html) |
| Help: | Make a SZGETMatrix-Point |
