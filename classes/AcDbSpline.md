...
| Types | Functions |
| --------- | --------- |
| Class: | [AcDbSpline-Closed](#AcDbSpline-Closed) <br> [AcDbSpline-EndTangent](#AcDbSpline-EndTangent) <br> [AcDbSpline-FitPoints](#AcDbSpline-FitPoints) <br> [AcDbSpline-FitTolerance](#AcDbSpline-FitTolerance) <br> [AcDbSpline-StartTangent](#AcDbSpline-StartTangent) <br> [AcDbSpline-User_Prompt](#AcDbSpline-User_Prompt) |
