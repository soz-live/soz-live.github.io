...
| Subclasses: | [DCLS-Dialog-List-DocPreview](DCLS-Dialog-List-DocPreview.html) <br> [DCLS-Dialog-List-ObjectKeySelect](DCLS-Dialog-List-ObjectKeySelect.html) <br> [DCLS-Dialog-List-SelectItem](DCLS-Dialog-List-SelectItem.html) |
| Interfaces: |  |
| Interfaced: |  |
| Abstract?: | Yes |
| isValue?: | Yes |
