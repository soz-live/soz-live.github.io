...
# Class:	DCLS-Tile-PopUp-OptionUserMethods
...
| Superclass: | [DCLS-Tile-PopUp-UserMethods](DCLS-Tile-PopUp-UserMethods.html) |
| Subclasses: |  |
| Interfaces: |  |
| Interfaced: |  |
| Abstract?: | No |
...
### DCLS-Tile-PopUp-OptionUserMethods-Make

| Keys | Types | Help |
| --------- | --------- | --------- |
| USER | [User](User.html) |  |
| | | |
| Returns: | [DCLS-Tile-PopUp-OptionUserMethods](DCLS-Tile-PopUp-OptionUserMethods.html) | |
| Help: | | Basic UserOption Constructor |
